...
if [ "${status_text}" == "active" ]
then
echo -e " Xray Vless Xtls Vision  : "$green"running"$NC" ✓"
else
...
if [ "${status_text}" == "active" ]
then
echo -e " Xray Vless Xhttp Tls    : "$green"running"$NC" ✓"
else
...
if [ "${status_text}" == "active" ]
then
echo -e " HttpUpgrade Ws Tls      : "$green"running"$NC" ✓"
else
...
if [ "${status_text}" == "active" ]
then
echo -e " Xray Vless Xhttp  None  : "$green"running"$NC" ✓"
else
...
if [ "${status_text}" == "active" ]
then
echo -e " HttpUpgrade Ws None     : "$green"running"$NC" ✓"
else
