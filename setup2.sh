...
echo "                                                                             ";
echo "                                                              "
echo -e "$Lyellow                ⚡ PREMIUM SCRIPT V3.0 ⚡"$NC
echo -e "$Lyellow         ⚡ MULTIPORT/LATEST XRAYCORE VERSION ⚡"$NC
echo -e "$green.........................................................."$NC
...
echo -e "$green.........................................................."$NC
echo ''
echo -e "$Lyellow                       Wait 7 Seconds!"$NC
echo -e "$green.........................................................."$NC
sleep 6
clear
if [ "${EUID}" -ne 0 ]; then
...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/oddloop/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloop/main/install/ssh-vpn2.sh && chmod +x ssh-vpn2.sh && screen -S ssh-vpn ./ssh-vpn2.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloop/main/install/ins-xray2.sh && chmod +x ins-xray2.sh && screen -S ins-xray ./ins-xray2.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
clear
#install ohp-server
echo -e "\e[0;32mINSTALLING OHP PORT...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloop/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/oddloop/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/oddloop/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
echo -e "\e[0;32mDONE INSTALLING OHP PORT\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/${GitUser}/oddloop/main/websocket-python/websocket2.sh && chmod +x websocket2.sh && screen -S websocket.sh ./websocket2.sh
echo -e "\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m"
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloop/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
